...
- 分支：`main`
- 快照提交：`5448657`（2026-09-19）
- 最新代码提交：`5448657`，Stock 已隐藏/已下架列表读取已接入可取消请求和过期响应保护，并纳入 StockPage 格式门禁；此前 QingLong 任务列表和真实后端 Users smoke 修复继续保留。
