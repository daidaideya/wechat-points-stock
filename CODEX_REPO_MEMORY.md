...
- 分支：`main`
- 快照提交：`ed78de2`（2026-09-19）
- 最新修复：Points 账号卡接入漏传 `item` 导致积分页渲染崩溃的问题已修复；桌面/移动导航自定义链接改为显式路由跳转，三浏览器 E2E smoke 当前为 `15 passed`。
