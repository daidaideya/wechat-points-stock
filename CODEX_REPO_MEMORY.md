...
- 分支：`main`
- 快照提交：`a19f135`（2026-09-19）
- 最新代码提交：`a19f135`，App 根布局移动导航已复用共享 `useViewport` 并覆盖桌面到 390px 的动态断点切换；真实后端 smoke 稳定性、Programs/Apps 共享视口、Stock/QingLong 读取保护和 Users smoke 修复继续保留。
