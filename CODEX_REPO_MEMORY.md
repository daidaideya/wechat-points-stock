...
- 分支：`main`
- 快照提交：`e8adce0`（2026-09-19）
- 最新代码提交：`e8adce0`，真实后端 Playwright smoke 已移除不必要的全局 `networkidle` 等待，改以页面真实数据断言同步；Programs/Apps 共享 `useViewport`、Stock/QingLong 读取保护和 Users smoke 修复继续保留。
